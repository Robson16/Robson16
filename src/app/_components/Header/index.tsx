    ...
    >
      <div className="container mx-auto">
        <nav className="flex items-start justify-between transition-all max-lg:px-4 max-lg:py-6 lg:items-center lg:justify-center lg:space-x-10">
          ...
          <div
            className={`z-1080 flex transition-all max-lg:absolute max-lg:top-0 max-lg:left-0 max-lg:h-screen max-lg:w-80 max-lg:bg-emerald-800 max-lg:px-4 max-lg:pt-20 lg:items-center lg:justify-center ${isOpen ? 'max-lg:translate-x-0' : 'max-lg:translate-x-[-120%]'}`}
          >
