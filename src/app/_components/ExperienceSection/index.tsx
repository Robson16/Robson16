  ...
  return (
    ...
    >
      <div className="bg-black/90">
        <div className="container mx-auto max-w-screen-sm px-4 py-28 xl:max-w-7xl">
          <div className="flex flex-col gap-20 xl:flex-row xl:gap-6">
            ...
            <div className="flex flex-1 flex-col gap-7">
              ...
              {education.map((edu) => (
                <div
                  key={edu.id}
                  className="flex min-h-64 max-w-125 flex-1 flex-col content-start gap-2 self-center rounded-lg bg-zinc-800 p-8 shadow-2xl md:min-w-125"
                >
                  ...
                  <ul className="list-inside text-sm">
                    {(
                      exp.responsibilities[
                        locale as keyof typeof exp.responsibilities
                      ] || exp.responsibilities.pt
                    ).map((resp, index) => (
