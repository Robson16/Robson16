      ...
      <div className="container max-w-screen-xl mx-auto py-28 px-4">
        <div className="columns-2 flex">
          <div className="flex flex-col justify-center flex-1">
            <h1 className="text-5xl font-bold mb-4">Robson H. Rodrigues</h1>
            ...
            <ul className="my-10">
              <li className="group flex items-center my-2">
                ...
                />
                <a href="https://www.agenciabeb.com.br/" target="_blank">
                  Agência B&B
                </a>
              </li>
              <li className="group flex items-center my-2">
          ...
          <div className="flex flex-col justify-center flex-1">
            <figure className="mx-auto rounded-full border border-[20px] border-zinc-950">
              <Image
                src="https://github.com/Robson16.png"
                alt="Picture of the author"
                width={360}
                height={360}
                className="mx-auto rounded-full border border-[20px] border-zinc-900"
              />
            </figure>
          </div>
        </div>
